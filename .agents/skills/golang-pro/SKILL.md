---
name: golang-pro
description: Implements concurrent Go patterns using goroutines and channels, designs DDD/hexagonal Go microservices with gRPC or REST, optimizes Go application performance with pprof, and enforces idiomatic Go with generics, interfaces, and robust error handling. Use when building Go applications requiring concurrent programming, DDD/CQRS architecture, microservices architecture, or high-performance systems. Invoke for goroutines, channels, Go generics, gRPC integration, CLI tools, benchmarks, repository adapters, or table-driven testing.
license: MIT
metadata:
  domain: language
...
| Architecture | `references/architacture.md` | DDD, hexagonal architecture, CQRS, ports/adapters, repository contracts |
| Go Common | `references/go-common.md` | Shared Go conventions, reusable helpers, cross-service patterns |
...
| I-Models | `references/i-models.md` | Integration models, DTO boundaries, model mapping conventions |
